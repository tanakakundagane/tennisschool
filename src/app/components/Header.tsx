  ...
  return (
    <div className="flex justify-between">
      ...
      {menuOpenend === false && mobile === true ? (
        ...
        >
          <IoMdMenu className="text-4xl text-lightGray" />
        </div>
      ) : (
        <ul className="flex gap-[2rem] text-white max-md:fixed max-md:flex-col max-md:right-[2rem] max-md:z-20 max-md:bg-darkGray max-md:p-[2rem]">
